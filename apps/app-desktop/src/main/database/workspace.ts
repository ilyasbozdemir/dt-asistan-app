...
const TEMPLATE_NAMES: Record<string, string> = {
  ...
  'komisyon-gorevlendirme-onayi': 'KOMİSYON GÖREVLENDİRME ONAYI (MUAYENE VE KABUL VE FİYAT ARAŞTIRMASI)',
  'komisyon-gorevlendirme-onayi-eki': 'KOMİSYON GÖREVLENDİRME ONAYI EKİ (MUAYENE VE KABUL VE FİYAT ARAŞTIRMASI)',
