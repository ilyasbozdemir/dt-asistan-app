...
import { Download, ExternalLink, Eye, Printer, Star, ChevronDown, MoreVertical, FileText } from 'lucide-react'
  ...
  const triggerElement = trigger ? (
    ...
    <button
      ...
      className={cn(
        ...
        menuOpen && 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-350'
      )}
    >
      ...
      {menuOpen && (
        <div className="absolute right-0 mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50 w-64 py-2 text-xs animate-in fade-in slide-in-from-top-1 duration-150">
          ...
          <div className="px-3 py-2 space-y-2">
            ...
            >
              <Star className={cn("w-3.5 h-3.5 shrink-0", isInDefaultList && "fill-amber-500 text-amber-500")} />
