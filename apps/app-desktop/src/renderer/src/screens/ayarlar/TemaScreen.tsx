...
const themeVariablesMeta: VariableMeta[] = [
  ...
  },
  {
    ...
    category: "text-bg",
    description:
      "Kenarlık çizgileri, buton/input sınırları ve girdi alanlarının arka planları.",
    defaultLight: "#f4f4f5",
    defaultDark: "#09090b",
  },
  {
  ...
  },
  {
    ...
    category: "sidebar",
    description:
      "Sol menüde seçili olan elemanın aktif sol kenarlık çizgisi rengi.",
...
const parseRgba = (
  rgbaStr: string,
): { hex: string; opacity: number; isRgba: boolean } => {
...
export default function TemaScreen({
  ...
  useEffect(() => {
    if (activeTab === "designer") {
      ...
      const lastRaw = designerMode === "light"
        ? lastRawSync.light
        : lastRawSync.dark;
  ...
  const handleImport = (): void => {
    try {
      ...
      if (typeof parsed.light === "string" && typeof parsed.dark === "string") {
        ...
        setImportJsonText("");
        showStatus(
          "Tema başarıyla içe aktarıldı. Uygulamak için kaydet butonuna basın.",
        );
      } else {
        alert(
          'Geçersiz tema JSON formatı. "light" ve "dark" alanları string olmalıdır.',
        );
      }
    } catch {
      alert(
        "Geçersiz JSON formatı. Lütfen kopyaladığınız içeriği kontrol edin.",
      );
    }
  };

  const renderColorInput = (key: string, value: string): React.JSX.Element => {
    const isRgbaVar = key === "--sidebar-active-bg" ||
      key === "--sidebar-active-border";
          ...
          <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Uygulamanın renk paletlerini, hazır temalarını ve CSS
          ...
          <div className="flex justify-between items-end border-b border-slate-200 dark:border-slate-800 pb-4">
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">
                Uygulama arayüzünde kullanılan renk paletlerini özelleştirin.
                Hazır temalardan birini seçebilir, dışa/içe aktarabilir veya
                kendi CSS değişkenlerinizi yazabilirsiniz.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <Button
      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex items-start gap-3 shadow-sm">
        ...
        <div className="text-sm text-amber-800 dark:text-amber-300 leading-relaxed">
          <strong className="font-semibold block mb-0.5">
            ⚠️ Yeniden Başlatma Gerekebilir
          </strong>
          Tema değişikliği sonrasında arayüzün bazı bölümlerinde (özellikle
          butonlar ve sol menüde) renk kaymaları görebilirsiniz. Yeni temanın
          her yere kusursuz yansıması için uygulamayı kapatıp{" "}
          <strong>tekrar açmanız (veya Ctrl+R ile sayfayı yenilemeniz)</strong>
          {" "}
          önerilir. Tekrar açtığınızda düzelecektir.
        </div>
      </div>
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
                {Object.entries(presets).map(([key, value]) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setPresetTheme(value.light, value.dark, value.name)}
            ...
            >
              <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                ...
                CSS Değişken Rehberi (Renk Anahtarları Ne İşe Yarar?)
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 text-xs leading-normal">
                <div className="space-y-2">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Birincil soft renk. Seçili elemanların arka planı, rozet
                      ve aktif kart arka planlarında kullanılır.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Birincil orta ton. Hover/odaklanma kenarlıkları ve aktif
                      buton gölgelerinde tercih edilir.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Birincil koyu/yüksek kontrast ton. Başlıklar, vurgulanması
                      gereken koyu etiket metinleri için.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Vurgu/İkincil soft renk. Alternatif butonlar, etiketler
                      veya ikincil aktif durumlar için.
                    </span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Birincil eylem rengi. Kaydet butonları, linkler ve ana
                      eylemlerin arka plan rengi.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Metin renkleri. 100 ana okuma metni (koyu/açık), 200 ise
                      açıklama ve alt başlıklar içindir.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Sırasıyla ana sayfa arka planı (100), kart/sidebar kutu
                      arka planı (200) ve kenarlık/input arka planları (300).
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5 pt-1 border-t border-slate-100 dark:border-slate-800">
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-400">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">
                      Sol menüde elemanların hover durumundaki arka plan ve yazı
                      rengi.
                    </span>
                  </div>
                  <div className="flex flex-col gap-0.5">
              ...
              <div className="p-3 bg-blue-50/40 dark:bg-blue-950/20 border border-blue-100/60 dark:border-blue-900/30 rounded-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs">
                <div className="leading-relaxed text-slate-600 dark:text-slate-400">
                  ...
                  Kendi özel renk paletinizi yapay zekayı (ChatGPT, Claude vb.)
                  kullanarak saniyeler içinde tasarlamak için{" "}
                  <strong>AI Prompt Yardımcısı</strong>{" "}
                  modülümüzü kullanabilirsiniz. Ya da harici{" "}
        ...
        : (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="flex items-center gap-2">
              ...
              {(["all", "primary", "text-bg", "sidebar"] as const).map((
                cat,
              ) => (
                <button
                  key={cat}
                        ...
                        >
                          ...
                          <div className="flex items-start gap-3">
                            <div
                              ...
                              style={{
                                backgroundColor: val.startsWith("rgba")
                                  ? val
                                  : val || "#cccccc",
                              }}
                            />
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 max-w-lg w-full shadow-2xl flex flex-col gap-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-550 dark:text-slate-400">
                  ChatGPT veya Claude için profesyonel bir renk paleti oluşturma
                  promptu hazırlar.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="block text-xs font-bold text-slate-600 dark:text-slate-400">
                Nasıl bir tema istersiniz? (Örn: Pastel Orman Yeşili, Retro
                Turuncu, Modern Gece Mavisi...)
              </label>
            ...
            {generatedPrompt && (
              <div className="space-y-2 animate-in slide-in-from-bottom-2 duration-200">
                ...
                <div className="flex items-center justify-between text-[10px] text-slate-500 bg-slate-50 dark:bg-slate-950/50 p-2.5 rounded-xl border border-slate-200/50 dark:border-slate-800/50 leading-relaxed">
                  <div>
                    💡 Promptu kopyalayıp aşağıdaki yapay zeka araçlarından
                    birine yapıştırın. Çıkan JSON kodunu kopyalayıp{" "}
                    <strong>Temayı İçe Aktar (JSON)</strong>{" "}
                    butonuyla buraya aktarabilirsiniz!
                  </div>
                </div>
                <div className="flex gap-2">
                  <a
      ...
      {showImportModal && (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 max-w-md w-full shadow-2xl flex flex-col gap-4">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Dışa aktardığınız veya paylaşılan tema JSON kodunu aşağıdaki alana
              kopyalayarak içe aktarın:
            </p>
            <textarea
