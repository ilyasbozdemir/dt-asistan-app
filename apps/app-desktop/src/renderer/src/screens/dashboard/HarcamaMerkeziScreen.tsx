          ...
          <div className="space-y-3 max-w-3xl">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-3 py-1 rounded-full text-xs font-black bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 flex items-center gap-1.5 uppercase tracking-wider">
                <Landmark className="w-3.5 h-3.5" /> HAKİM Pro • Harcama & Hakediş Merkezi
              </span>
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full sm:w-auto shrink-0">
            ...
            <div className="flex items-center gap-2">
              <Link to="/" className="flex-1">
                <Button
                  variant="outline"
                  className="w-full border-slate-700 hover:bg-slate-800 text-slate-200 text-xs font-semibold py-2.5 px-4 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              olmadan hakediş vezneden çıkamaz. Sistem bu kesintileri kuruşu kuruşuna otomatik yapar.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              hakedişin ayrılmaz ekidir. HAKİM Pro dizi pusulasında tüm ekleri eksiksiz numaralandırır.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                type="button"
                onClick={() => {
                  setWizardSelection((prev) => ({ ...prev, kategori: 'yapim' }))
                  setWizardStep(1)
                }}
              ...
              <button
                type="button"
                onClick={() => {
                  setWizardSelection((prev) => ({ ...prev, kategori: 'hizmet' }))
                  setWizardStep(1)
                }}
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link to="/dosyalar/yeni">
                <Button className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold py-2.5 px-5 rounded-xl shadow-md cursor-pointer">
                  Bu Süreçle Dosya Oluştur <ArrowRight className="w-3.5 h-3.5 ml-1" />
                </Button>
              </Link>
              <Button
                variant="outline"
