...
export function MalzemeListesi(): React.JSX.Element {
  ...
  const [editingMaddeIndex, setEditingMaddeIndex] = useState<number | null>(
    null,
  );
  ...
  return (
    ...
    >
        ...
        {maddeler.length === 0
          ? (
            <div className="flex flex-col items-center justify-center text-center p-6 text-slate-400">
              ...
              <p className="text-xs">
                Lüzum müzekkeresinde malzeme tablosunun altında görünecek
                herhangi bir özel şart eklenmemiş.
              </p>
            </div>
          )
          : (
      ...
      <Modal
        ...
        title={editingMaddeIndex !== null
          ? "Madde / Şart Düzenle"
          : "Yeni Madde / Şart Ekle"}
