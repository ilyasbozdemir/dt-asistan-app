              ...
              return (
                <div key={log.version} className="relative pl-6 animate-in fade-in duration-300">
                  ...
                  {index !== changelog.length - 1 && (
                    <div className="absolute left-[4px] top-4 bottom-[-24px] w-0.5 bg-slate-100 dark:bg-slate-800"></div>
                  )}
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            {backlog.map((section, sIdx) => (
              <div key={sIdx} className="space-y-3">
                <div className="flex items-center gap-1.5 text-xs font-bold text-indigo-750 dark:text-indigo-400">
                  <Sparkles className="w-4 h-4 text-indigo-555" />
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="mt-2.5 flex items-center gap-1.5">
                            ...
                            <span className="text-[8px] font-extrabold uppercase bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2 py-0.5 rounded">
                              Düşünce
                            </span>
                          </div>
                        </div>
