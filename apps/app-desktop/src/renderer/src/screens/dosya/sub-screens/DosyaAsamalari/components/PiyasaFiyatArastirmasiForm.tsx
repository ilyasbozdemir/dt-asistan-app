                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
                      ...
                      Dağıtılan teklif formlarından gelen verileri bu alana
                      ekleyebilir, yaklaşık maliyet cetveli ve piyasa fiyat
                      araştırma tutanağı belgelerini çıkartabilirsiniz.
                    </p>
                  </div>
