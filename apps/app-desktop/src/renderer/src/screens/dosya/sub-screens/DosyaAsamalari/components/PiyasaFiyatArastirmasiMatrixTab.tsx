        ...
        <div className="flex flex-col gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200/60 dark:border-blue-800/60 rounded-xl p-4 flex items-start gap-3">
            <div className="mt-0.5">
              <svg className="w-5 h-5 text-blue-600 dark:text-blue-450" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-[11px] text-blue-700 dark:text-blue-300 mt-1 leading-relaxed">
                Firmalara dağıtılan <strong>teklif formlarından</strong> gelen fiyatları aşağıdaki matrise girebilirsiniz. Girdiğiniz veriler otomatik hesaplanarak Yaklaşık Maliyet Cetveli ve Piyasa Fiyat Araştırma Tutanağı'nı oluşturmanızı sağlar.
              </p>
            </div>
          </div>
          <TeklifMatrisi
