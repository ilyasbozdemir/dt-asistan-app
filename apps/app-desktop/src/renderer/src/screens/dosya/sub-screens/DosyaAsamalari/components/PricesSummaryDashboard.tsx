...
import { AlertCircle, Building2, Check, ClipboardList } from 'lucide-react'
    ...
    return (
      <div className="py-10 text-center flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-xs text-slate-450 dark:text-slate-500 max-w-md">
          Fiyat tekliflerini görmek için lütfen "Yeni Tutanak Ekle / Teklif Girişi" butonuna
          tıklayarak firmaları davet edin ve teklifleri girin.
        </p>
      </div>
    )
  }
