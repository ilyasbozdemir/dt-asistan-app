  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        <DropdownMenuItem onClick={onPrintOrderForm} disabled={!onPrintOrderForm}>
          <ShoppingCart className="mr-2 h-4 w-4 text-amber-500" />
          <span>Sipariş Formu</span>
        </DropdownMenuItem>

        <DropdownMenuItem onClick={onPrintContract} disabled={!onPrintContract}>
        ...
        <DropdownMenuItem onClick={onViewFirmaDetails} disabled={!onViewFirmaDetails}>
          <Building2 className="mr-2 h-4 w-4 text-cyan-500" />
          <span>Firma Bilgileri</span>
        </DropdownMenuItem>

        <DropdownMenuItem onClick={onViewTeklifHistory} disabled={!onViewTeklifHistory}>
