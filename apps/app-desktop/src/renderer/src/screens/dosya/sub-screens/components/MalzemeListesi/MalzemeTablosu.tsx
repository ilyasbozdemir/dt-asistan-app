...
export function MalzemeTablosu({
  ...
  const selectedKomisyon = selectedKomisyonlar.length > 0 ? 'muayene_kabul_tespit' : ''
                        ...
                        >
                          ...
                          <div className="shrink-0">
                            <BelgeAksiyonlari
                              ...
                              onQuickPrint={() => onQuickPrint && onQuickPrint(sablon)}
                              onExport={(fmt) => onExport && onExport(sablon, fmt)}
                              onOpenExternal={() => onOpenExternal && onOpenExternal(sablon)}
                              disabled={isDisabled}
                              docName={cleanName}
                            />
                          </div>
