...
import { Activity, Layers, Tag, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
          Sistemde tanımlı olan müdürlükleri, harcama birimlerini, DETSİS
          kodlarını ve personelleri tek ekrandan inceleyin.
        </p>
      </div>
              ...
              {birimler.map((b) => (
                ...
                >
                  ...
                  <td
                    ...
                    title={b.harcama_yetkilisi_unvan}
                  >
