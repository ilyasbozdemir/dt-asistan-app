    ...
    if (activeDosya) {
      ...
      setTeminTarihi(
        activeDosya.temin_tarihi
          ? activeDosya.temin_tarihi.substring(0, 10)
          : "",
      );
      setTeslimTarihi(
        activeDosya.teslim_tarihi
          ? activeDosya.teslim_tarihi.substring(0, 10)
          : "",
      );
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
                ...
                <div className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed space-y-3">
                  <p>
                    ...
                    olarak doldurulur. Süreç boyunca yaptığınız her giriş anında
                    evraklara yansır.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <div className="p-3.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/60 rounded-2xl flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10.5px] text-slate-500 leading-normal">
                          Şablonların yerleşimleri ve içerikleri mevzuata uygun
                          şekilde dinamik olarak bağlanmıştır.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-3.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/60 rounded-2xl flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10.5px] text-slate-500 leading-normal">
                          İhtiyaç listesini girerek süreci başlatırsınız. Bu
                          adıma göre Lüzum Müzekkeresi ve Harcama Talimatı gibi
                          başlangıç belgeleri üretilir.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-3.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/60 rounded-2xl flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10.5px] text-slate-500 leading-normal">
                          Firma tekliflerini girdiğinizde, komisyonlar ve
                          yaklaşık maliyet hesaplamaları otomatik olarak dolup
                          cetvel haline getirilir.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-3.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/60 rounded-2xl flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10.5px] text-slate-500 leading-normal">
                          Kazanan firmayı atar, sözleşme basar ve son aşamada
                          Muayene Kabul Tutanağı ile süreci kapatıp imzaya
                          çıkarırsınız.
                        </p>
                      </div>
                    </div>
                      ...
                      dbBelgeler.map((belge) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleToggleSign(belge.id, belge.is_signed)}
            ...
            <div className="p-8 rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 text-center flex flex-col items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 max-w-md mx-auto mt-2 leading-relaxed">
                  ...
                  için listeden bir dosya seçerek aktif hale getirin veya
                  aşağıdaki genel durumu inceleyin.
                </p>
              </div>
              <Link to="/dosyalar">
