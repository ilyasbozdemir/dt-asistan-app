...
export const TEMPLATE_EDITABLE_FIELDS: Record<string, TemplateFieldConfig[]> = {
  'harcama-talimati': [
    ...
    { key: 'onayaSunulanTarih', label: 'Onaya Sunulan Tarih', type: 'date', category: 'tarih' },
    { key: 'onayTarihi', label: 'Onay Tarihi (OLUR Tarihi)', type: 'date', category: 'tarih' },
  ...
  'harcama-pusulasi': [
    ...
    { key: 'aciklama', label: 'Açıklama', type: 'textarea', category: 'genel' },
    { key: 'evrakSayisi', label: 'Evrak Sayısı (Sayı)', type: 'text', category: 'tarih' },
    { key: 'tarih', label: 'Tarih', type: 'date', category: 'tarih' },
    { key: 'onaylayanPersonelAdi', label: 'Harcama Yetkilisi Adı', type: 'text', category: 'personel' },
    { key: 'onaylayanPersonelUnvan', label: 'Harcama Yetkilisi Ünvanı', type: 'text', category: 'personel' },
  ],
  ...
  'birim-fiyat-teklif-mektubu': [
    ...
    { key: 'eposta', label: 'E-Posta', type: 'text', category: 'personel' },
    { key: 'aciklama', label: 'Açıklama / Taahhüt Metni', type: 'textarea', category: 'genel' },
    { key: 'dosyaTarihi', label: 'Tarih', type: 'date', category: 'tarih' },
  ],
  'arastirma-mektubu': [
  ...
  'piyasa-fiyat-arastirma-tutanagi': [
    { key: 'isAdi', label: 'İşin Adı', type: 'text', category: 'genel' },
    { key: 'idareAdi', label: 'İdare Adı', type: 'text', category: 'genel' },
    { key: 'evrakSayisi', label: 'Sayı / Evrak No', type: 'text', category: 'tarih' },
    { key: 'dosyaTarihi', label: 'Onay Tarihi', type: 'date', category: 'tarih' },
    { key: 'tarih', label: 'Düzenleme Tarihi', type: 'date', category: 'tarih' },
    { key: 'aciklama', label: 'Açıklama', type: 'textarea', category: 'genel' },
    { key: 'baskanAdi', label: 'Harcama Yetkilisi Adı', type: 'text', category: 'personel' },
    { key: 'baskanUnvan', label: 'Harcama Yetkilisi Ünvanı', type: 'text', category: 'personel' },
  ],
  'piyasa-fiyat-arastirma-gorevlendirmesi': [
    { key: 'dosyaKonusu', label: 'İşin Adı / Konu', type: 'text', category: 'genel' },
    { key: 'evrakSayisi', label: 'Sayı / Evrak No', type: 'text', category: 'tarih' },
    { key: 'dosyaTarihi', label: 'Dosya Tarihi', type: 'date', category: 'tarih' },
    { key: 'onaylayanPersonelAdi', label: 'Harcama Yetkilisi Adı', type: 'text', category: 'personel' },
    { key: 'onaylayanPersonelUnvan', label: 'Harcama Yetkilisi Ünvanı', type: 'text', category: 'personel' },
  ],
  'yaklasik-maliyet-cetveli': [
    { key: 'isAdi', label: 'İşin Adı', type: 'text', category: 'genel' },
    { key: 'mudurluk', label: 'Müdürlük / Birim', type: 'text', category: 'genel' },
    { key: 'tarih', label: 'Düzenleme Tarihi', type: 'date', category: 'tarih' },
  ]
};
