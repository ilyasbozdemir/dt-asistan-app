...
export const TemplateVariablesSchema: Record<string, TemplateVariableDef> = {
  ...
  firma_adi: { label: 'İstekli Firma Adı', type: 'string', kaynak_tablo: 'TANIM_Firma', kaynak_sutun: 'unvan', varsayilan: 'Firma A.Ş.', description: 'Temin edilecek firmanın ticari ünvanı' },
  firma_vkn: { label: 'Vergi No / TCKN', type: 'string', kaynak_tablo: 'TANIM_Firma', kaynak_sutun: 'vergi_no', description: 'Firmanın vergi numarası' },
  tarih: { label: 'Tarih', type: 'date', varsayilan: '01.01.2024', description: 'Belgenin oluşturulduğu tarih' },
  ...
  hazirlayanPersonelAdi: { label: 'Hazırlayan Personel Adı', type: 'string', varsayilan: 'Ahmet Yılmaz' },
  hazirlayanPersonelUnvan: { label: 'Hazırlayan Personel Ünvanı', type: 'string', varsayilan: 'Memur' },
  onaylayanPersonelAdi: { label: 'Onaylayan Personel Adı', type: 'string', varsayilan: 'Ayşe Kaya' },
  onaylayanPersonelUnvan: { label: 'Onaylayan Personel Ünvanı', type: 'string', varsayilan: 'Müdür' },
  ...
  toplam_tutar: { label: 'Toplam Tutar', type: 'string', kaynak_tablo: 'DATA_TeminDosyasi', kaynak_sutun: 'yaklasik_maliyet', description: 'Dosyanın toplam tutarı' },
