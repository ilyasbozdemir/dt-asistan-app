                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-[200px]">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        {birim.e_butce && (
                          <span className="inline-flex items-center gap-1 font-mono text-[10px] text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-1.5 py-0.5 rounded-md">
                    ...
                    <div className="flex-1 min-w-[150px] text-xs text-slate-600 dark:text-slate-400">
                      ...
                      {birim.ihtiyac_yeri_eki && (
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          <span className="truncate max-w-[200px]">{birim.ihtiyac_yeri_eki.split('\n')[0]}...</span>
                        </div>
                      )}
                    </div>
