...
export function IhtiyacListesiTab(props: YeniDosyaTabProps) {
  const {
    formData,
    setFormData,
    isEdit,
                  ...
                  <div className="space-y-6 animate-in fade-in duration-300">
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-4 items-start md:items-center">
                        <div>
                          ...
                          <p className="text-xs text-blue-600 dark:text-blue-500 mt-1">
                            İhale kalemlerinizi (OKAS kodlarıyla) ekleyerek
                            Birim Fiyat Teklif Cetveli oluşturabilirsiniz.
                          </p>
                        </div>
                    ...
                    <div className="py-12 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50 dark:bg-slate-950">
                      ...
                      <p className="text-xs text-slate-500 mt-1 max-w-sm text-center">
                        Doğrudan temin kapsamında alınacak mal, hizmet veya
                        yapım işi kalemlerini buradan ekleyin.
                      </p>
                    </div>
                      ...
                      <div className="bg-slate-50 dark:bg-slate-950 px-5 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-[10px] text-slate-500 mt-0.5">
                            Önceki ihalelerdeki benzer kalemlerin fiyat geçmişi
                            referans amaçlıdır.
                          </p>
                        </div>
                      </div>
