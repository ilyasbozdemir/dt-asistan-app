    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Uygulama arayüzünde ve belge çıktılarında kullanılacak logoları
      ...
      <div className="flex items-start gap-2 p-3 bg-blue-50/60 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 rounded-xl text-xs text-blue-700 dark:text-blue-400 leading-relaxed">
        ...
        <span>
          <strong>Önerilen boyutlar:</strong> Uygulama Logosu için{" "}
          <strong>256×256 px</strong> veya <strong>512×512 px</strong>{" "}
          (kare, şeffaf arka planlı PNG tercih edilir). Belge logoları (Sol/Sağ)
          için <strong>300×150 px</strong> önerilir. Maksimum dosya boyutu:{" "}
          <strong>2 MB</strong>.
        </span>
      </div>
