...
export function AiTemplateGeneratorModal({ isOpen, onClose, currentHtml, onApply }: AiTemplateGeneratorModalProps) {
    ...
    >
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={onClose} disabled={isGenerating}>İptal</Button>
          <Button 
